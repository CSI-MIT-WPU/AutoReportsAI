            ...
            <div className='w-full grid grid-cols-3 gap-4'>
                <div className='col-span-1 p-5 border border-slate-300 rounded-lg space-y-3'>
                    <div className='space-y-1'>
                        <img src="/dashboard.png" alt="" className='border border-slate-300 rounded-lg' />
                    ...
                    <p className='text-base text-slate-800'>Introducing AutoReportsAI, a cutting edge AI solution for modern businesses.</p>
                </div>
            </div>
