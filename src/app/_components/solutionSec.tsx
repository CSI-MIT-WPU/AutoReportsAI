    ...
    return (
        <div className='w-full bg-neutral-100 py-16'>
            <div className="w-full flex flex-col items-center justify-center space-y-5">
                ...
                <h2 className="text-5xl font-semibold dark:text-black">Empower Your Business with AI Workflows</h2>
                <p className='text-base font-medium text-center leading-6 tracking-wide text-slate-600 max-w-2xl'>Generic AI tools won't suffice. Our platform is purpose-built to provide exceptional AI-driven solutions for your unique business needs.</p>
            </div>
