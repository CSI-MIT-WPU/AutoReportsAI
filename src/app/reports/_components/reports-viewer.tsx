                                ...
                                <div className="font-semibold text-center text-2xl">
                                    {
                                        report.dateRange?.from?.seconds && report.dateRange?.to?.seconds ? (
                                            ...
                                            `Report between ${new Date(report.dateRange.from.seconds * 1000).toLocaleDateString("en-GB")} and Date Not Provided`
                                        ) : report.dateRange?.to?.seconds ? (
                                            `Report between Date Not Provided and ${new Date(report.dateRange.to.seconds * 1000).toLocaleDateString("en-GB")}`
                                        ) : (
                                            "Report between Date Not Provided and Date Not Provided"
                                        )
                                    }
                                </div>
